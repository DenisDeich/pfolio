...
import PetBook from "../../Assets/Projects/petbook.png";
        ...
        <Row style={{ justifyContent: "center", paddingBottom: "10px" }}>
          <Col md={6} lg={4} className="project-card">
            <ProjectCard
              ...
              ghLink="https://github.com/DenisDeich/React-JunkFoodApp"
          ...
          <Col md={6} lg={4} className="project-card">
            <ProjectCard
              imgPath={PetBook}
              title="Petbook social media"
              description="Create an account for your pet. Regestered users can write posts and find friends"
              ghLink="https://github.com/JasonDiaz289/Full-Stack-Project-Stuff"
          ...
          <Col md={6} lg={4} className="project-card">
            <ProjectCard
              ...
              ghLink="#"
              demoLink="https://github.com/DenisDeich/SeeYou"
            />
          </Col>
